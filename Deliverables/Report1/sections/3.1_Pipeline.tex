...
Supported macro-architectures are Direct and Autoencoder. The encoder may be RNN/LSTM/GRU, Conv1D (temporal convolutions with pooling), or MultiScaleCNN (parallel convolutional branches at multiple receptive fields).
A feed-forward head performs classification.
In the Autoencoder setting, the decoder mirrors the encoder.