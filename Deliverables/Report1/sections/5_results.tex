...
Because no checkpoints were available for the best trial, all five folds were retrained using the reconstructed architecture. The resulting fold-level F1 scores were:
\[
\{0.9632,\; 0.9418,\; 0.9270,\; 0.9451,\; 0.9359\},
\]
leading to an average cross-validation macro F1 of \textbf{0.9426}.  
A performance-weighted ensemble was then constructed, resulting in an estimated ensemble F1 of \textbf{0.9427}.
